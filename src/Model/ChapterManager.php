...
class ChapterManager extends AbstractManager
{
    ...
    public function insert(array $chapter, int $storyId, array $author)
    {
        $query = "INSERT INTO " . self::TABLE . " 
        (title, pseudo, content, story_id, author_id) VALUES (:title, :pseudo, :content, :story_id, :author_id);";
        ...
        $statement->bindValue(':author_id', $author['id'], PDO::PARAM_INT);
